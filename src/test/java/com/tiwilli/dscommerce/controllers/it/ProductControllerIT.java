...
public class ProductControllerIT {
    ...
    public void insertShouldReturnProductDTOCreatedWhenAdminLogged() throws Exception {
        ...
        result.andExpect(jsonPath("$.imgUrl").value(product.getImgUrl()));
    ...
    @Test
    public void insertShouldReturnUnprocessableEntityWhenAdminLoggedAndPriceIdNegative() throws Exception {
    ...
    @Test
    public void deleteShouldReturnNoContentWhenExistingProductAndAdminLogged() throws Exception {
    ...
    @Test
    public void deleteShouldReturnNotFoundWhenNonExistingProductAndAdminLogged() throws Exception {
    ...
    public void deleteShouldReturnBadRequestWhenDependentProductAndAdminLogged() throws Exception {
    ...
    @Test
    public void deleteShouldReturnUnauthorizesWhenInvalidToken() throws Exception {
